  ...
  $(window).scroll(function () {
    ...
    if (scroll >= 25) {
      if (!logo.hasClass("scroll-logo")) {
        logo.removeClass('lrg-logo').addClass("scroll-logo").fadeIn("slow"), layout.addClass("scroll-layout").fadeIn("slow"), backTop.addClass("active");
      }
    } else {
      if (!logo.hasClass("lrg-logo")) {
        logo.removeClass("scroll-logo").addClass('lrg-logo').fadeIn("slow"), layout.removeClass("scroll-layout").fadeIn("slow"), backTop.removeClass("active");
      }
    }
  });
});
    ...
    if (window.innerWidth < 460) {
      if (scroll >= 25) {
        if (!nav.hasClass("scroll-nav")) {
          nav.removeClass('lrg-nav').addClass("scroll-nav").fadeIn("slow"), header.addClass("scroll-header");
        }
      } else {
        if (!nav.hasClass("lrg-nav")) {
          nav.removeClass("scroll-nav").addClass('lrg-nav').fadeIn("slow"), header.removeClass("scroll-header");
          ;
        }
      }
    }
...
__webpack_require__(/*! /Users/shady/Desktop/fffcorp21/src/js/02_swiper.min.js */"./src/js/02_swiper.min.js");
__webpack_require__(/*! /Users/shady/Desktop/fffcorp21/src/js/03_darkmode.js */"./src/js/03_darkmode.js");
__webpack_require__(/*! /Users/shady/Desktop/fffcorp21/src/js/04_intersectionObserver.js */"./src/js/04_intersectionObserver.js");
